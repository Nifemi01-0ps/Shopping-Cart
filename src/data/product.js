...
// fetch() from file:// origin, NOT an image loading issue.
//
// Product sections:
...
const DUMMYJSON_STATIC = [
  { id:1,  title:'iPhone 9',                    price:549,  disc:12.96, rating:4.69, stock:94,  cat:'smartphones',    img:'https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=600&q=80', fallbackImg:'https://picsum.photos/seed/iphone-9/600/600' },
  { id:2,  title:'iPhone X',                    price:899,  disc:17.94, rating:4.44, stock:34,  cat:'smartphones',    img:'https://images.unsplash.com/photo-1574944985070-8f3ebc6b79d2?w=600&q=80', fallbackImg:'https://picsum.photos/seed/iphone-x/600/600' },
  { id:3,  title:'Samsung Galaxy S23',          price:799,  disc:15.46, rating:4.09, stock:36,  cat:'smartphones',    img:'https://images.unsplash.com/photo-1610945415295-d9bbf067e59c?w=600&q=80', fallbackImg:'https://picsum.photos/seed/samsung-s23/600/600' },
  { id:4,  title:'OPPO F19',                    price:280,  disc:17.91, rating:4.30, stock:123, cat:'smartphones',    img:'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=600&q=80', fallbackImg:'https://picsum.photos/seed/oppo-f19/600/600' },
  { id:5,  title:'MacBook Pro 2021',            price:1749, disc:11.02, rating:4.57, stock:83,  cat:'laptops',        img:'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=600&q=80', fallbackImg:'https://picsum.photos/seed/macbook-pro/600/600' },
  { id:6,  title:'Samsung Galaxy Book',         price:1499, disc:17.63, rating:4.25, stock:50,  cat:'laptops',        img:'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=600&q=80', fallbackImg:'https://picsum.photos/seed/samsung-laptop/600/600' },
  { id:7,  title:'Microsoft Surface Laptop 4',  price:1499, disc:10.23, rating:4.43, stock:68,  cat:'laptops',        img:'https://images.unsplash.com/photo-1525547719571-a2d4ac8945e2?w=600&q=80', fallbackImg:'https://picsum.photos/seed/surface-laptop/600/600' },
  { id:8,  title:'HP Pavilion Gaming Laptop',   price:1099, disc:6.18,  rating:4.43, stock:89,  cat:'laptops',        img:'https://images.unsplash.com/photo-1593642632559-0c6d3fc62b89?w=600&q=80', fallbackImg:'https://picsum.photos/seed/hp-gaming/600/600' },
  { id:9,  title:'Dior J\'adore Perfume',       price:89,   disc:8.40,  rating:4.26, stock:65,  cat:'fragrances',     img:'https://images.unsplash.com/photo-1541643600914-78b084683702?w=600&q=80', fallbackImg:'https://picsum.photos/seed/dior-jadore/600/600' },
  { id:10, title:'Royal Mirage Sport Brown',    price:40,   disc:15.66, rating:4.00, stock:52,  cat:'fragrances',     img:'https://images.unsplash.com/photo-1523293182086-7651a899d37f?w=600&q=80', fallbackImg:'https://picsum.photos/seed/royal-mirage/600/600' },
  { id:11, title:'Eyeshadow Palette',           price:19,   disc:13.60, rating:3.79, stock:84,  cat:'beauty',         img:'https://images.unsplash.com/photo-1512496015851-a90fb38ba796?w=600&q=80', fallbackImg:'https://picsum.photos/seed/eyeshadow-palette/600/600' },
  { id:12, title:'Red Lipstick',                price:12,   disc:19.03, rating:4.23, stock:68,  cat:'beauty',         img:'https://images.unsplash.com/photo-1586495777744-4e6232bec854?w=600&q=80', fallbackImg:'https://picsum.photos/seed/red-lipstick/600/600' },
  { id:13, title:'Mascara',                     price:13,   disc:17.00, rating:4.28, stock:58,  cat:'beauty',         img:'https://images.unsplash.com/photo-1631214524020-3c69bfa9e4e1?w=600&q=80', fallbackImg:'https://picsum.photos/seed/mascara/600/600' },
  { id:14, title:'Skin Rescue Moisturiser',     price:40,   disc:19.00, rating:4.56, stock:54,  cat:'skincare',       img:'https://images.unsplash.com/photo-1596755389378-c31d21fd1273?w=600&q=80', fallbackImg:'https://picsum.photos/seed/skin-moisturiser/600/600' },
  { id:15, title:'Facial Gentle Cleanser',      price:20,   disc:10.00, rating:4.36, stock:56,  cat:'skincare',       img:'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?w=600&q=80', fallbackImg:'https://picsum.photos/seed/luminous-serum/600/600' },
  { id:16, title:'Women\'s Floral Summer Dress',price:55,   disc:18.00, rating:4.45, stock:90,  cat:'womens-dresses', img:'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?w=600&q=80', fallbackImg:'https://picsum.photos/seed/floral-dress/600/600' },
  { id:17, title:'Women\'s Long Knit Dress',    price:70,   disc:19.08, rating:4.23, stock:79,  cat:'womens-dresses', img:'https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?w=600&q=80', fallbackImg:'https://picsum.photos/seed/knit-dress/600/600' },
  { id:18, title:'Women\'s Knit Sweater',       price:18,   disc:16.07, rating:4.16, stock:65,  cat:'womens-tops',    img:'https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=600&q=80', fallbackImg:'https://picsum.photos/seed/knit-sweater/600/600' },
  { id:19, title:'Women\'s Running Shoes',      price:89,   disc:12.00, rating:4.38, stock:45,  cat:'womens-shoes',   img:'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600&q=80', fallbackImg:'https://picsum.photos/seed/adidas-boost/600/600' },
  { id:20, title:'Men\'s Classic Polo Shirt',   price:31,   disc:10.00, rating:4.07, stock:125, cat:'mens-shirts',    img:'https://images.unsplash.com/photo-1620012253295-c15cc3e65df4?w=600&q=80', fallbackImg:'https://picsum.photos/seed/mens-polo/600/600' },
  { id:21, title:'Men\'s Slim Fit Chinos',      price:45,   disc:8.00,  rating:4.22, stock:88,  cat:'mens-shirts',    img:'https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=600&q=80', fallbackImg:'https://picsum.photos/seed/mens-chinos/600/600' },
  { id:22, title:'Men\'s Casual Sneakers',      price:79,   disc:14.00, rating:4.35, stock:60,  cat:'mens-shoes',     img:'https://images.unsplash.com/photo-1543508282-6319a3e2621f?w=600&q=80', fallbackImg:'https://picsum.photos/seed/casual-sneakers/600/600' },
  { id:23, title:'Men\'s Automatic Watch',      price:199,  disc:12.00, rating:4.55, stock:40,  cat:'mens-watches',   img:'https://images.unsplash.com/photo-1587836374828-4dbafa94cf0e?w=600&q=80', fallbackImg:'https://picsum.photos/seed/automatic-watch/600/600' },
  { id:24, title:'Women\'s Rose Gold Watch',    price:159,  disc:9.00,  rating:4.41, stock:55,  cat:'womens-watches', img:'https://images.unsplash.com/photo-1548169874-53e85f753f1e?w=600&q=80', fallbackImg:'https://picsum.photos/seed/rosegold-watch/600/600' },
  { id:25, title:'Diamond Stud Earrings',       price:120,  disc:15.00, rating:4.62, stock:30,  cat:'womens-jewellery',img:'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=600&q=80', fallbackImg:'https://picsum.photos/seed/diamond-earrings/600/600' },
  { id:26, title:'Gold Chain Necklace',         price:85,   disc:11.00, rating:4.18, stock:47,  cat:'womens-jewellery',img:'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=600&q=80', fallbackImg:'https://picsum.photos/seed/gold-necklace/600/600' },
  { id:27, title:'Boho Macrame Plant Hanger',   price:41,   disc:17.00, rating:4.08, stock:131, cat:'home-decoration', img:'https://images.unsplash.com/photo-1463320726281-696a485928c7?w=600&q=80', fallbackImg:'https://picsum.photos/seed/plant-hanger/600/600' },
  { id:28, title:'Scented Soy Candles Set',     price:29,   disc:10.00, rating:4.34, stock:95,  cat:'home-decoration', img:'https://images.unsplash.com/photo-1602874801007-bd458bb1a698?w=600&q=80', fallbackImg:'https://picsum.photos/seed/soy-candles/600/600' },
  { id:29, title:'Resistance Bands Set',        price:25,   disc:8.00,  rating:4.27, stock:200, cat:'sports-accessories',img:'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=600&q=80', fallbackImg:'https://picsum.photos/seed/body-lotion/600/600' },
  { id:30, title:'Polarised Sunglasses',        price:49,   disc:13.00, rating:4.15, stock:73,  cat:'sunglasses',     img:'https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=600&q=80', fallbackImg:'https://picsum.photos/seed/sunglasses/600/600' },
];
...
function mapDummyLive(p) {
  ...
  const badge      = rating >= 4.5 ? 'hot' : disc >= 15 ? 'sale' : null;
...
export async function fetchDummyProducts() {
  ...
  try {
    const url  = isLocalhost()
      ? '/api/dummyjson/products?limit=30&skip=0'
      : 'https://dummyjson.com/products?limit=30&skip=0';
    const data = await fetchWithTimeout(url);
    _dummyCache = (data.products || []).map(mapDummyLive);
    console.log(`[ShopFlow] DummyJSON live: ${_dummyCache.length} products loaded`);
    return _dummyCache;
  } catch (err) {
    console.warn(`[ShopFlow] DummyJSON unavailable (${err.message}) — using static fallback`);
    _dummyCache = DUMMYJSON_STATIC_MAPPED;
    return _dummyCache;
  }
}
